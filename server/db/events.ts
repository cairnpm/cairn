...
export type EventAction = 'created' | 'signal_added' | 'field_updated' | 'bet' | 'pass' | 'defer' | 'pr_linked' | 'pr_merged' | 'issue_opened' | 'issue_closed' | 'stale' | 'merged' | 'discarded' | 'deleted' | 'restored' | 'assigned' | 'unassigned'
